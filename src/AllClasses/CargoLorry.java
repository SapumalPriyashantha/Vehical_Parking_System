...
public class CargoLorry implements Vehical{
    ...
    int[] reservedSlotLorry =new int[7];
    ...
    public CargoLorry(String vehical_number, String vehical_type, String maximum_weigth, String num_of_passengers) {
